...
- Customize the system instruction in `constants/constants.ts`
- Modify the UI in `ChatWidget.tsx`
- Add more tools in `geminiService.ts`
- Adjust Tailwind styles in `tailwind.config.js`
